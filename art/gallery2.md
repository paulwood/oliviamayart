...
{% include gallery-layout.html gallery=site.data.galleries.gallery2 id_number=1 %}

The pictures from part two:

{% include gallery-layout.html gallery=site.data.galleries.gallery2 id_number=2 %}
